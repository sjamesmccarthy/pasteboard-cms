...
# Database: pbdev
# Generation Time: 2010-01-04 22:13:06 -0800
# ************************************************************
...
CREATE TABLE `pb_page` (
  ...
  `page_meta_pragma` varchar(255) default NULL,
...
INSERT INTO `pb_page` (`page_id`,`fk_user_id`,`page_slug`,`page_title`,`page_content`,`page_meta_description`,`page_meta_keywords`,`page_meta_robots`,`page_meta_pragma`,`page_meta_expires`,`page_template`,`page_created`,`page_modified`,`page_password`,`page_status`,`page_type`,`page_lock`)
VALUES
...
INSERT INTO `pb_user` (`user_id`,`fk_roles_id`,`user_login`,`user_password`,`user_email`,`user_first_name`,`user_last_name`,`user_activation_key`,`user_registered`,`user_hint`,`user_hint_answer`,`user_status`,`user_last_login`,`user_created`)
VALUES
	(1,1,'james','my4girl$','james.mccarthy@gmail.com','James','McCarthy','0000','0000-00-00 00:00:00','0','0\n',1,'2009-01-04 13:50:23','2009-01-04 13:50:23');
